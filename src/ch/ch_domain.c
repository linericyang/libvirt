...
{
    printf("virCHDomainObjPrivateAlloc\n");
...
{
    printf("virCHDomainObjPrivateFree\n");
...
virCHDomainObjPrivateXMLFormat(virBufferPtr buf,
                               virDomainObjPtr vm)
{
    printf("virCHDomainObjPrivateXMLFormat\n");
...
{
    printf("virCHDomainObjPrivateXMLParse\n");
    virCHDomainObjPrivatePtr priv = vm->privateData;
    long long thepid;
...
{
    printf("virCHDomainDefPostParse\n");
